...
while 1:
    ...
    ║  {Fore.YELLOW}SEX! Aracı{Fore.LIGHTCYAN_EX}                                         ║
    ...
    # Anasını sikme modu
        ...
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "SİKMEK İSTEDİĞİN TELEFON NUMARASINI YAZ +90 sız: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no1 = input()
        try:
            int(tel_no1)
            if len(tel_no1) != 10:
        ...
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "SİKMEK İSTEDİĞİN 2. TELEFON NUMARASINI YAZ +90 sız: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no2 = input()
        try:
            int(tel_no2)
            if len(tel_no2) != 10:
        ...
        system("cls||clear")
        send_sms = SendSms(tel_no1, tel_no2, mail)
        try:
            while True:
